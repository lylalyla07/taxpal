  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <div className='mt-10 flex justify-center gap-x-6'>
        ...
        <Button href='https://topcoderfullstack.com' variant="outline">
          <HeroRegSvg />
      ...
      <div className='mt-36 lg:mt-44'>
        ...
        <ul role='list' className='mt-8 flex justify-center items-center gap-x-8 sm:flex-col sm:gap-x-0 sm:gap-y-10 xl:flex-row xl:gap-x-12 xl:gap-y-0'>
          {

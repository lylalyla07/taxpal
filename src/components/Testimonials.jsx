                ...
                <ul role='list' className='flex flex-col gap-6 sm:gap-y-8'>
                  {
                    testimonialGroup.map((testimonial, testimonialIndex) => (
                      <li key={testimonialIndex}>
                        <figure className='relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10 overflow-hidden'>
                          <QuoteIcon className="absolute left-6 top-6 fill-slate-100" />
                          <blockquote className='relative text-lg text-slate-900 tracking-tight'>{testimonial.content}</blockquote>
                          <figcaption className='relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6'>
                            ...
                            <Image
                              ...
                              className='h-14 w-14 object-cover overflow-hidden rounded-full bg-slate-50'
                              alt=""
                              width={56}
                              height={56}
                            />
